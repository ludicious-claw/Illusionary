...
local Library = {
    ...
    AccentColor = Color3.fromRGB(142,0,0);
...
local Templates = { -- TO-DO: do it for missing elements.
    ...
    Window = {
        ...
        Center = false,
        BackgroundImage = "rbxassetid://80318163285804"
    },
...
do
    ...
    local WatermarkIcon = Library:Create("ImageLabel", {
        Image = "rbxassetid://80318163285804";
...
do
    ...
    function Library:Notify(...)
        ...
        -- Ajouter transparence à l'outline
        ...
        Library:AddToRegistry(OutlineStroke, {
            Color = "OutlineColor";
        }, true)
...
function Library:CreateWindow(...)
	...
	Library.BackgroundImage = BackgroundImage
	    ...
	    -- Pulse animation on background image
	    local BackgroundPulseTween = nil
	    local function StartBackgroundPulse()
	        if BackgroundPulseTween then
	            BackgroundPulseTween:Cancel()
	        end
	        BackgroundPulseTween = TweenService:Create(
	            BackgroundImage,
	            TweenInfo.new(2.5, Enum.EasingStyle.Sine, Enum.EasingDirection.InOut, -1, true),
	            { ImageTransparency = 0.55 }
	        )
	        BackgroundPulseTween:Play()
	        Library.BackgroundImagePulseTween = BackgroundPulseTween
	    end
	
	    local function StopBackgroundPulse()
	        if BackgroundPulseTween then
	            BackgroundPulseTween:Cancel()
	            BackgroundPulseTween = nil
	        end
	        BackgroundImage.ImageTransparency = 0.8
	    end
	
	    Library.StartBackgroundPulse = StartBackgroundPulse
	    Library.StopBackgroundPulse = StopBackgroundPulse
	
	    BackgroundImage:GetPropertyChangedSignal("Visible"):Connect(function()
